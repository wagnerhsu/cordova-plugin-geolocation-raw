...
#pragma mark -
#pragma mark CDVRawLocation

@implementation CDVRawLocation
...
- (void)getLocation:(CDVInvokedUrlCommand*)command
{
    [self.commandDelegate runInBackground:^{
        ...
        if ([[command arguments] count] > 0) {
            //enableHighAccuracy = [[command argumentAtIndex:0] boolValue];
        }
...
- (void)configLocation:(CDVInvokedUrlCommand *)command {
    CDVPluginResult *commandResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString:@"success"];
